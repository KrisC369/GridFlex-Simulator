 ...
 *
 */
public final class RetributionFactorSensitivityRunner5A {
    ...
    private RetributionFactorSensitivityRunner5A() {
    ...
    public static void main(String[] args) {
        new RetributionFactorSensitivityRunner5A().runExperiments();
    }
}
