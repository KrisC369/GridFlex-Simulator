...
public class SerializationRegression {
    ...
    private String HARDCODED_EXPECTED_CONTEXT_SERIALIZATION_POST_REBRAND =
            "";
    ...
    @Test
    public void testDeserializeContextPreRebrand() throws IOException, ClassNotFoundException {
        byte[] decoded = Base64.getDecoder().decode(
                HARDCODED_EXPECTED_CONTEXT_SERIALIZATION_PRE_REBRAND);
    ...
    @Test
    public void testSerializeContextPreRebrand() throws IOException {
        ...
        assertEquals(HARDCODED_EXPECTED_CONTEXT_SERIALIZATION_PRE_REBRAND, pickledAsb64String);
