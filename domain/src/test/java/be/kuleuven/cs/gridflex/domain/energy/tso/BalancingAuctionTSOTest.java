...
import be.kuleuven.cs.gridflex.domain.energy.tso.auctioning.BalancingAuctionTSO;
import be.kuleuven.cs.gridflex.domain.util.FlexBid;
...
public class BalancingAuctionTSOTest {
    ...
    public void testPlaceBids() {
        FlexBid bid = new FlexBid(FlexTuple.create(1, 500, FlexTuple.Direction.fromRepresentation(false), 0, 0, 0),
                125);
        tso.placeBid(bid);
