...
import be.kuleuven.cs.flexsim.solvers.heuristic.domain.comparators
        .ActivationAssignmentDifficultyComparator;
import be.kuleuven.cs.flexsim.solvers.heuristic.domain.comparators.IntegerStrengthComparator;
