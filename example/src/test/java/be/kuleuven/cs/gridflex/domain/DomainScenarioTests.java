package be.kuleuven.cs.gridflex.domain;
...
import be.kuleuven.cs.gridflex.domain.energy.generation.RandomOutputGenerator;
...
import be.kuleuven.cs.gridflex.domain.process.ProductionLine;
...
import be.kuleuven.cs.gridflex.domain.site.SiteImpl;
...
public class DomainScenarioTests {
    ...
    public void setUp() throws Exception {
        ...
        p = new ProductionLineBuilder().addShifted(14)
